    ...
    fetch('https://striveschool-api.herokuapp.com/api/reservation', {
      ...
      .then((response) => {
        if (response.ok) {
          ...
          setFormValues(initialFormValues) // D R Y

          // qui dovremmo trovare il modo per "avvisare" ReservationList
          // e dirgli di ri-effettuare la GET delle prenotazioni!
          props.toggleTrigger() // così invertiamo il valore di "trigger" in App
        } else {
      ...
      <Row className="justify-content-center mt-3">
        <Col xs={12} md={8} lg={6}>
          <Form onSubmit={submitForm}>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={
                  ...
                  (e) => {
                    setFormValues({
                      ...formValues, // riporto tutte le 6 proprietà
            ...
            {formValues.name.toLocaleLowerCase() === 'giangiorgio' && (
              <Alert variant="info">BEL NOME!</Alert>
            )}
              ...
              <Form.Control
                ...
                onChange={(e) => {
                  ...
                  setFormValues({
                    ...formValues, // riporto tutte le 6 proprietà
                    // dello stato corrente
                    phone: e.target.value, // il carattere che ho
                    // appena inserito nell'input
                  })
                }}
              />
              ...
              <Form.Select
                ...
                onChange={(e) => {
                  ...
                  setFormValues({
                    ...formValues, // riporto tutte le 6 proprietà
                    // dello stato corrente
                    numberOfPeople: e.target.value, // il carattere che ho
                    // appena inserito nell'input
                  })
                }}
              >
              ...
              <Form.Check
                ...
                onChange={(e) => {
                  ...
                  setFormValues({
                    ...formValues, // riporto tutte le 6 proprietà
                    // dello stato corrente
                    smoking: e.target.checked, // il carattere che ho
                    // appena inserito nell'input
                  })
                }}
              />
              ...
              <Form.Control
                ...
                onChange={(e) => {
                  ...
                  setFormValues({
                    ...formValues, // riporto tutte le 6 proprietà
                    // dello stato corrente
                    dateTime: e.target.value, // il carattere che ho
                    // appena inserito nell'input
                  })
                }}
              />
              ...
              <Form.Control
                ...
                onChange={(e) => {
                  ...
                  setFormValues({
                    ...formValues, // riporto tutte le 6 proprietà
                    // dello stato corrente
                    specialRequests: e.target.value, // il carattere che ho
                    // appena inserito nell'input
                  })
                }}
              />
